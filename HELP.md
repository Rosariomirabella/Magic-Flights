...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.5.0-M3/reference/data/sql.html#data.sql.jdbc)
* [Thymeleaf](https://docs.spring.io/spring-boot/3.5.0-M3/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
